...
describe('widget item event class', () => {
  ...
  it('should return a widgetItemEvent object mapped to its DTO', () => {
    ...
    const widgetItemEventDTO = new WidgetItemEvent(widgetItemEventData).toDTO();
  ...
  it(`should throw an error if 'language' provided is invalid`, () => {
    ...
    expect(() => new WidgetItemEvent(invalidWidgetItemEventData)).toThrow(ErrorMessages.MV_0007);
  });
  ...
  it(`should throw an error if 'currency' provided is invalid`, () => {
    ...
    expect(() => new WidgetItemEvent(invalidWidgetItemEventData)).toThrow(ErrorMessages.IV_0015);
  });
  ...
  it(`should not throw an error if 'language' is undefined`, () => {
    ...
    expect(() => new WidgetItemEvent(invalidWidgetItemEventData)).not.toThrow();
  });
