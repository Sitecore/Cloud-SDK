...
Scenario Outline: Developer sends search widget click event from browser with a valid payload
    Given the '/send-widget-click-event' page is loaded
    ...
    """
     ...
     """
    And the 'sendWidgetClickEvent' button is clicked
...
Scenario: Developer sends search widget click event from Middleware with a valid payload
    Given the '/send-widget-click-event' page is loaded with 'testID' name and 'sendWidgetClickEventFromMiddleware' value query parameter
    Then the request with id 'sendWidgetClickEventFromMiddleware' will contain:
    """
