...
Scenario Outline: Developer calls personalize from middleware with enablePersonalizeCookie set to true
    ...
    When the '/create-personalize-cookie' page is loaded with 'testID' name and 'initWithEnablePersonalizeCookieFromMiddleware' value query parameter
...
Scenario Outline: Developer calls personalize from middleware with enablePersonalizeCookie set to false
    When the '/create-personalize-cookie' page is loaded with 'testID' name and 'initWithoutEnablePersonalizeCookieFromMiddleware' value query parameter
...
Scenario: A guestId cookie already exists on the page, enablePersonalizeCookie set to true doesn't create a new cookie but updates TTL
    Given the '/create-personalize-cookie' page is loaded with 'testID' name and 'initWithEnablePersonalizeCookieFromMiddlewareTTL' value query parameter
    And server guest id cookie is created on the '/create-personalize-cookie' page   
    When the '/create-personalize-cookie' page is loaded with 'testID' name and 'initWithEnablePersonalizeCookieFromMiddlewareTTL' value query parameter
