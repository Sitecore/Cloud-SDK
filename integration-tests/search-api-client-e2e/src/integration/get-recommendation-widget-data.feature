Feature: Request recommendation widget data from Search REST API
  ...
  Scenario: Developer requests recommendation widget data from browser with a valid payload
    ...
    Examples:
      | items                                                                                                                                                                                       | items_request_payload                                                                                                                                                                        |
      | [{"rfkId":"rfkid_7","entity":"content"}]                                                                                                                                                    | [{"rfk_id":"rfkid_7","entity":"content"}]                                                                                                                                                    |
      | [{"rfkId":"rfkid_7","entity":"content","recommendations":{}}]                                                                                                                               | [{"rfk_id":"rfkid_7","entity":"content","recommendations":{}}]                                                                                                                               |
      | [{"rfkId":"rfkid_7","entity":"content","recommendations":{"content":{}}}]                                                                                                                   | [{"rfk_id":"rfkid_7","entity":"content","recommendations":{"content":{}}}]                                                                                                                   |
      | [{"rfkId":"rfkid_7","entity":"content","recommendations":{"content":{"fields":["id"]}}}]                                                                                                    | [{"rfk_id":"rfkid_7","entity":"content","recommendations":{"content":{"fields":["id"]}}}]                                                                                                    |
      | [{"rfkId":"rfkid_7","entity":"content","recommendations":{"content":{"fields":["id","type"]}}}]                                                                                             | [{"rfk_id":"rfkid_7","entity":"content","recommendations":{"content":{"fields":["id","type"]}}}]                                                                                             |
      | [{"rfkId":"rfkid_7","entity":"content","recommendations":{"filter":{"name":"title","type":"eq","value":"title1"}}}]                                                                         | [{"rfk_id":"rfkid_7","entity":"content","recommendations":{"filter":{"name":"title","type":"eq","value":"title1"}}}]                                                                         |
      | [{"rfkId":"rfkid_7","entity":"content","recommendations":{"filter":{"type":"or","filters":[{"type":"lt","name":"title","value":"50"},{"type":"gt","name":"title","value":"0"}]}}}]          | [{"rfk_id":"rfkid_7","entity":"content","recommendations":{"filter":{"type":"or","filters":[{"type":"lt","name":"title","value":"50"},{"type":"gt","name":"title","value":"0"}]}}}]          |
      | [{"rfkId":"rfkid_7","entity":"content","recommendations":{"filter":{"type":"geoDistance","name":"title","distance":"10km"}}}]                                                               | [{"rfk_id":"rfkid_7","entity":"content","recommendations":{"filter":{"type":"geoDistance","name":"title","distance":"10km"}}}]                                                               |
      | [{"rfkId":"rfkid_7","entity":"content","recommendations":{"filter":{"type":"allOf","name":"title","values":["test"]}}}]                                                                     | [{"rfk_id":"rfkid_7","entity":"content","recommendations":{"filter":{"type":"allOf","name":"title","values":["test"]}}}]                                                                     |
      | [{"rfkId":"rfkid_7","entity":"content","recommendations":{"filter":{"type":"geoWithin","name":"title","coordinates":[{"lat":0.3,"lon":0.3},{"lat":0.3,"lon":0.3},{"lat":0.3,"lon":0.3}]}}}] | [{"rfk_id":"rfkid_7","entity":"content","recommendations":{"filter":{"type":"geoWithin","name":"title","coordinates":[{"lat":0.3,"lon":0.3},{"lat":0.3,"lon":0.3},{"lat":0.3,"lon":0.3}]}}}] |
      | [{"rfkId":"rfkid_7","entity":"content","recommendations":{"groupBy": "type"}}]                                                                                                              | [{"rfk_id":"rfkid_7","entity":"content","recommendations":{"group_by":"type"}}]                                                                                                              |
      | [{"rfkId":"rfkid_7","entity":"content","recommendations":{"limit":1}}]                                                                                                                      | [{"rfk_id":"rfkid_7","entity":"content","recommendations":{"limit":1}}]                                                                                                                      |
  ...
  Scenario: Developer requests recommendation widget data from browser with a invalid payload
    ...
    Examples:
      ...
      | [{"rfkId":"rfkid_7","entity":"content","recommendations":{"recipe":{"id":"","version":1}}}]           | [IV-0023] Incorrect value for recipe "id". Set the value to a non-empty string.                         |
      | [{"rfkId":"rfkid_7","entity":"content","recommendations":{"recipe":{"id":"recipe-123","version":0}}}] | [IV-0024] Incorrect value for recipe "version". Set the value to an integer greater than or equal to 1. |