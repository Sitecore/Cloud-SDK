Feature: Request recommendation widget data from Search REST API
  ...
  Scenario: Developer requests recommendation widget data from browser with a valid payload
    ...
    Examples:
      ...
      | [{"widgetId":"rfkid_7","entity":"content","recommendations":{"content":{"fields":["id"]}}}]                                                                                                    | [{"rfk_id":"rfkid_7","entity":"content","recommendations":{"content":{"fields":["id"]}}}]                                                                                                    |
      | [{"widgetId":"rfkid_7","entity":"content","recommendations":{"content":{"fields":["id","type"]}}}]                                                                                             | [{"rfk_id":"rfkid_7","entity":"content","recommendations":{"content":{"fields":["id","type"]}}}]                                                                                             |
