Feature: Request questions widget data from Search REST API
  ...
  Scenario: Developer requests questions widget data from browser with a valid payload
    ...
    Examples:
      | items                                                                                                                                                                                                    | items_request_payload                                                                                                                                                                                       |
      | [{"rfkId":"rfkid_qa","entity":"content","questions":{"keyphrase":"test"}}]                                                                                                                               | [{"rfk_id":"rfkid_qa","entity":"content","questions":{"keyphrase":"test"}}]                                                                                                                                 |
      | [{"rfkId":"rfkid_qa","entity":"content","questions":{"exactAnswer":{},"keyphrase":"test"}}]                                                                                                              | [{"rfk_id":"rfkid_qa","entity":"content","questions":{"exact_answer":{},"keyphrase":"test"}}]                                                                                                               |
      | [{"rfkId":"rfkid_qa","entity":"content","questions":{"relatedQuestions":{},"keyphrase":"test"}}]                                                                                                         | [{"rfk_id":"rfkid_qa","entity":"content","questions":{"related_questions":{},"keyphrase":"test"}}]                                                                                                          |
      | [{"rfkId":"rfkid_qa","entity":"content","questions":{"exactAnswer":{ "includeSources":true, "queryTypes": ["keyword", "question", "statement"] },"keyphrase":"test"}}]                                   | [{"rfk_id":"rfkid_qa","entity":"content","questions":{"exact_answer":{ "include_sources":true, "query_types": ["keyword", "question", "statement"] },"keyphrase":"test"}}]                                  |
      | [{"rfkId":"rfkid_qa","entity":"content","questions":{"keyphrase":"test","relatedQuestions":{"filter":{"type":"eq","name":"test","value":["test","test2"]},"includeSources":true,"limit":1,"offset":1}}}] | [{"rfk_id":"rfkid_qa","entity":"content","questions":{"keyphrase":"test","related_questions":{"filter":{"type":"eq","name":"test","value":["test","test2"]},"include_sources":true,"limit":1,"offset":1}}}] |
  ...
  Scenario: Developer requests question widget data from browser with a invalid payload
    ...
    Examples:
      | items                                                                                                       | error_code                                                                                                      |
      | [{"rfkId":"rfkid_qa","entity":"content","questions":{"keyphrase":""}}]                                      | [IV-0009] Incorrect value for "​keyphrase"​​. Set the value to a string between 1 and 100 characters inclusive. |
      | [{"rfkId":"rfkid_qa","entity":"content","questions":{"relatedQuestions":{"limit":-1},"keyphrase":"test"}}]  | [IV-0007] Incorrect value for "limit". Set the value to an integer between 1 and 100 inclusive.                 |
      | [{"rfkId":"rfkid_qa","entity":"content","questions":{"relatedQuestions":{"limit":200},"keyphrase":"test"}}] | [IV-0007] Incorrect value for "limit". Set the value to an integer between 1 and 100 inclusive.                 |
      | [{"rfkId":"rfkid_qa","entity":"content","questions":{"relatedQuestions":{"offset":-1},"keyphrase":"test"}}] | [IV-0008] Incorrect value for "offset". Set the value to an integer greater than or equal to 0.                 |
