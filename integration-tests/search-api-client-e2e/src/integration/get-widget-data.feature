Feature: Request widget data from Search REST API
    ...
    Scenario Outline: Developer requests widget data from browser with a valid payload
        ...
        Examples:
            ...
            | [{"rfkId":"rfkid_7","entity":"content", "search": {"offset": 1,"limit": 5,"content": {}}}]                                                                       | [{"rfkId":"rfkid_7","entity":"content","search": {"content":{},"offset": 1,"limit": 5}}]                                                                                             | 200         | [{"rfkId":"rfkid_7","entity":"content","search": {"offset": 1,"limit": 5,"content": 5}}]                                                                  |
            | [{"rfkId":"rfkid_7","entity":"content"}]                                                                                                                         | [{"rfkId":"rfkid_7","entity":"content"}]                                                                                                                                             | 200         | [{"rfkId":"rfkid_7","entity":"content","search": {"limit": 10,"offset": 0,"content": 10}}]                                                                |
            | [{"rfkId":"rfkid_7","entity":"content", "search": {"limit": 10, "content": {}}}]                                                                                 | [{"rfkId":"rfkid_7","entity":"content","search": {"content":{},"limit": 10}}]                                                                                                        | 200         | [{"rfkId":"rfkid_7","entity":"content","search": {"limit": 10,"offset": 0,"content": 10}}]                                                                |
            ...
            | [{"rfkId":"rfkid_7","entity":"content", "search": {"content": {}, "filter": "add"}}]                                                                             | [{"rfkId":"rfkid_7","entity":"content","search": {"content":{},"filter" : {"name": "location", "type": "geoDistance", "distance": "3000km", "lat": -16.181724, "lon": -47.277881}}}] | 400         | {}                                                                                                                                                        |
            | [{"rfkId":"rfkid_7","entity":"content", "search": {"content": {}, "filter": "remove"}}]                                                                          | [{"rfkId":"rfkid_7","entity":"content","search":{"content": {}}}]                                                                                                                    | 200         | [{"rfkId":"rfkid_7","entity":"content","search": {"limit": 10,"offset": 0,"content": 10}}]                                                                |
    ...
    Scenario Outline: Developer requests widget data with context object from browser with a valid payload
        ...
        Examples:
            ...
            | [{"rfkId":"rfkid_7","entity":"content","search":{"limit":20,"offset":1}}] | {"user":{"userId":"tuid"}}                                                                                                        | {"user":{"user_id":"tuid"}}                                                                                                         | 200         |
            | [{"rfkId":"rfkid_7","entity":"content","search":{"limit":20,"offset":1}}] | {"user":{"uuid":"123"}}                                                                                                           | {"user":{"uuid":"123"}}                                                                                                             | 200         |
            | [{"rfkId":"rfkid_7","entity":"content","search":{"limit":20,"offset":1}}] | {"user":{"uuid":"123", "userId": "tuid"}}                                                                                         | {"user":{"uuid":"123", "user_id": "tuid"}}                                                                                          | 200         |
            | [{"rfkId":"rfkid_7","entity":"content","search":{"limit":20,"offset":1}}] | {"user":{"userId":"tuid","custom":{"key1":"value1","key2":"value2"}}}                                                             | {"user":{"user_id":"tuid", "custom":{"key1":"value1","key2":"value2"}}}                                                             | 200         |
            | [{"rfkId":"rfkid_7","entity":"content","search":{"limit":20,"offset":1}}] | {"ids":{"test":["test"]},"locale":{"country":"us","language":"en"}}                                                               | {"ids":{"test":["test"]},"locale":{"country":"us","language":"en"}}                                                                 | 200         |
            | [{"rfkId":"rfkid_7","entity":"content","search":{"limit":20,"offset":1}}] | {"ids":{},"locale":{"country":"us","language":"en"}}                                                                              | {"locale":{"country":"us","language":"en"}}                                                                                         | 200         |
