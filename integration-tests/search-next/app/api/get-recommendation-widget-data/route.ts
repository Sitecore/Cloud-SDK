...
import { getWidgetData, RecommendationWidgetItem, WidgetRequestData } from '@sitecore-cloudsdk/search/server';
...
export async function GET(req: NextRequest, res: NextResponse) {
  ...
  switch (testID) {
    case 'getRecommendationWidgetDataFromAPIWithValidPayload':
