Feature: Request widget data from Search REST API
    ...
    Scenario Outline: Developer requests widget data from browser with a valid payload
        ...
        Examples:
            ...
            | [{"widgetId":"rfkid_7","entity":"content", "search": {"offset": 1,"limit": 5,"content": {"fields": ["name"]}}}]                                                     | [{"widgetId":"rfkid_7","entity":"content","search": {"offset": 1,"limit": 5,"content": {"fields": ["name"]}}}]                                                                          | [{"widgetId":"rfkid_7","entity":"content","search": {"offset": 1,"limit": 5,"content": 5}}]                                                                  |
            ...
            | [{"widgetId":"rfkid_7","entity":"content", "search": {"offset": 5,"content": {"fields": ["name"]}}}]                                                                | [{"widgetId":"rfkid_7","entity":"content","search": {"offset": 5,"content": {"fields": ["name"]}}}]                                                                                     | [{"widgetId":"rfkid_7","entity":"content","search": {"limit": 10,"offset": 5,"content": 10}}]                                                                |
            | [{"widgetId":"rfkid_7","entity":"content", "search": {"offset": 5,"content": {"fields": ["name"]}, "query": {"keyphrase": "symposium"}}}]                           | [{"widgetId":"rfkid_7","entity":"content","search": {"offset": 5,"content": {"fields": ["name"]}, "query": {"keyphrase": "symposium"}}}]                                                | [{"widgetId":"rfkid_7","entity":"content","search": {"limit": 10,"offset": 5,"content": 10, "query": {"keyphrase": "symposium"}}}]                           |
            | [{"widgetId":"rfkid_7","entity":"content", "search": {"offset": 5,"content": {"fields": ["name"]}, "query": {"keyphrase": "XB123!*&)-+"}}}]                         | [{"widgetId":"rfkid_7","entity":"content","search": {"offset": 5,"content": {"fields": ["name"]}, "query": {"keyphrase": "XB123!*&)-+"}}}]                                              | [{"widgetId":"rfkid_7","entity":"content","search": {"limit": 10,"offset": 5,"content": 10, "query": {"keyphrase": "XB123!*&)-+"}}}]                         |
            | [{"widgetId":"rfkid_7","entity":"content", "search": {"offset": 5,"content": {"fields": ["name"]}, "query": {"keyphrase": "Sitecore Ireland", "operator": "or"}}}]  | [{"widgetId":"rfkid_7","entity":"content","search": {"offset": 5,"content": {"fields": ["name"]}, "query": {"keyphrase": "Sitecore Ireland", "operator": "or"}}}]                       | [{"widgetId":"rfkid_7","entity":"content","search": {"limit":10, "offset": 5,"content": 10, "query": {"keyphrase": "Sitecore Ireland", "operator": "or"}}}]  |
            | [{"widgetId":"rfkid_7","entity":"content", "search": {"offset": 5,"content": {"fields": ["name"]}, "query": {"keyphrase": "Sitecore Ireland", "operator": "and"}}}] | [{"widgetId":"rfkid_7","entity":"content","search": {"offset": 5,"content": {"fields": ["name"]}, "query": {"keyphrase": "Sitecore Ireland", "operator": "and"}}}]                      | [{"widgetId":"rfkid_7","entity":"content","search": {"limit":10, "offset": 5,"content": 10, "query": {"keyphrase": "Sitecore Ireland", "operator": "and"}}}] |
